...
This concept is a wide generalization of the spirograph : every function traced by the spirograph can be traced by the cosmoscope but the cosmoscope can actually trace any 2D function, using composition more as a tool rather than a constraint.
